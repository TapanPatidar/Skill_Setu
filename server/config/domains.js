/**
 * Domain Taxonomy & Competencies (Single Source of Truth)
 * Covers Engineering, Management, Healthcare & Ayush, Science & Research,
 * Commerce & Finance, Law & Policy, Design & Arts, Media & Communication,
 * Education, Agriculture & Agri-Tech, Hospitality & Tourism.
 */
...
/**
 * Returns flat list of all domains
 */
export const getAllDomains = () => Object.keys(DOMAIN_TAXONOMY);

/**
 * Returns subfields for a given domain
 */
...
/**
 * Returns all skills across a specific domain or all domains
 */
